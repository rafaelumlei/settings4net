...
This project provides a framework and tools that enable **.NET** applications to be configured in a centralized remote server. The settings are implemented using normal code and no synchronization code is necessary.
